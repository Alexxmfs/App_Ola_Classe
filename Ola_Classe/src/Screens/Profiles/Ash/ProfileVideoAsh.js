...
const ProfileVideoAsh = ({ navigation }) => {
  return (
    <View>
      <View>
        <Image source={assets.backgroundAsh} style={styles.backgroundImg} />
      </View>
      ...
      >
        <ButtonImagensHover onPress={() => navigation.navigate("profileAsh")} />
        <ButtonVideosHover
          onPress={() => navigation.navigate("ProfileVideoAsh")}
        />
      </View>
      <View
        style={{
...
export default ProfileVideoAsh;
